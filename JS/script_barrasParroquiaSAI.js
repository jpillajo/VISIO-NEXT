...
function actualizarGrafico() {
    ...
    if(document.getElementById('rbParroquiasUrbanas').checked == true) {   
        selectedValue = "R";
        respObtenerParroquiaUoR=document.getElementById('rbParroquiasUrbanas').value;
    } else {  
        selectedValue = "U";
        respObtenerParroquiaUoR=document.getElementById('rbParroquiasRurales').value;
    }
    ...
    var radio = document.querySelector('input[type=radio][name=rbParroquiasUoR]:checked');
    radio.checked = false;    
}
